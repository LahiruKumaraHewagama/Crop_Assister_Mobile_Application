    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        body: NestedScrollView(
            ...
            body: Container(
              padding:
                  const EdgeInsets.symmetric(vertical: 1.0, horizontal: 50.0),
              child: Column(
                children: <Widget>[
                  ...
                  const Text(
                      '“CropAssister” is mobile application to submit the compensation claims together with evidence of damage (E.g. photos/videos) which allows the crop damage compensation process to be more effective and less fraudulent.',
                      style: TextStyle(
                          fontStyle: FontStyle.normal,
                          fontSize: 13,
                          color: Color.fromARGB(255, 4, 92, 9)),
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      primary:
                          const Color.fromARGB(255, 71, 143, 75), // background
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => ClaimDashboard(uid: widget.uid)),
                  );
                },
              ),
              ListTile(
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => FarmerEditData(uid: widget.uid)),
                  );
                },
              ),
              ListTile(
